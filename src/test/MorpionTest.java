...
public class MorpionTest {
	...
	public void remainingGames() {
		...
		Assert.assertEquals("4 games for player1, 3 games for player2", game.report());
	}
	...
	public void winner() {
		...
		Assert.assertEquals("Game Over, player1 is a winner", game.report());
	}
	...
	public void displayEqualityGame() {
		...
		game.play("player1", "2x2");
		Assert.assertEquals("Game Over, equality", game.report());
		...
		Assert.assertEquals(expectedDisplay.toString(), game.display());
	}
}
